...
#define VBE_MODE_INFO		0x4F01 /**< @brief command to VBE mode information */
#define VBE_INFO			0x4F00 /**< @brief command to VBE information */
...
} __attribute__((packed)) vbe_config_info;
...
/**
 * @brief returns VBE information on config
 *
